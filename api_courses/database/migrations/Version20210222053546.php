...
class Version20210222053546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        app('db')->connection($connection)->statement('CREATE TABLE courses (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(150) NOT NULL, author_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
