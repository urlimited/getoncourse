...
export const apiGetArrangementsByReportId = (reportId) => dispatch => {
    dispatch(core_events.eventInitRequest());

    return fetch(constants.API_GET_EVENTS_BY_REPORT_ID + "?report_id=" + reportId, (new DefaultRequest()).setParams({
        method: "get",
        headers: {
